...
function wpjam_attribute_string($attributes, $type=''){
	return WPJAM_Util::attribute_string($attributes, $type);
}
...
function wpjam_get_field_name_object($name){
	return WPJAM_Field_Name::get_instance($name);
}

function wpjam_get_field_group_object(){
	return WPJAM_Field_Group::get_instance();
}
