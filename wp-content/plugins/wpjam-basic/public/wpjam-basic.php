	...
	public function get_sections(){
		...
		if($GLOBALS['plugin_page'] == 'wpjam-basic'){
			$disabled_fields	= $this->parse_fields([
				...
				'disable_autoembed'			=>['title'=>'屏蔽Auto Embeds',	'short'=>'bvpdzh-KxtotVp5QVT5D4A',	'description'=>'禁用Auto Embeds功能，加快页面解析速度。'],
			...
			$enhance_fields		= [
				'google_fonts_set'		=>['title'=>'Google字体加速',	'type'=>'fieldset',	'fields'=>WPJAM_Google_Font_Service::get_fields()],
				'gravatar_set'			=>['title'=>'Gravatar加速',	'type'=>'fieldset',	'fields'=>WPJAM_Gravatar_Service::get_fields()],
				'x-frame-options'		=>['title'=>'Frame嵌入',		'type'=>'select',	'options'=>[''=>'所有网页', 'SAMEORIGIN'=>'只允许同域名网页', 'DENY'=>'不允许任何网页']],
				...
				'frontend_set'			=>['title'=>'前台优化',		'type'=>'fieldset',	'fields'=>$this->parse_fields([
					...
					'remove_capital_P_dangit'	=>['slug'=>'remove-capital_p_dangit',				'description'=>'移除 WordPress 大小写修正，让用户自己决定怎么写。'],
				])],
				'backend_set'			=>['title'=>'后台优化',		'type'=>'fieldset',	'fields'=>$this->parse_fields([
					...
					'disable_google_fonts_4_block_editor'	=>['slug'=>'wordpress-disable-google-font-for-gutenberg',	'description'=>'屏蔽古腾堡编辑器加载 Google 字体。']
				])],
				'optimized_by_wpjam'	=>['title'=>'WPJAM Basic',	'type'=>'checkbox',	'description'=>'在网站底部显示：Optimized by WPJAM Basic。']
			];
